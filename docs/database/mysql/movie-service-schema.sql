...
CREATE TABLE movies (
    ...
    public_id CHAR(36) NOT NULL UNIQUE COMMENT 'Opaque public identifier generated by application',
...
CREATE TABLE movie_translations (
    ...
    locale VARCHAR(10) NOT NULL COMMENT 'vi, en',
    title VARCHAR(255) NOT NULL,
    synopsis TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    CONSTRAINT uk_movie_translation_locale UNIQUE (movie_id, locale),
...
CREATE TABLE movie_credits (
    ...
    role_type VARCHAR(30) NOT NULL COMMENT 'DIRECTOR, ACTOR, WRITER, PRODUCER',
...
CREATE TABLE movie_production_companies (
    ...
    role VARCHAR(50) NOT NULL DEFAULT 'PRODUCTION' COMMENT 'PRODUCTION, DISTRIBUTOR, STUDIO',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    created_by BIGINT NULL,
    PRIMARY KEY (
        movie_id,
...
CREATE TABLE movie_versions (
    ...
    public_id CHAR(36) NOT NULL UNIQUE,
    movie_id BIGINT NOT NULL,
    version_name VARCHAR(150) NOT NULL COMMENT '2D Vietsub, IMAX Vietsub, 2D Lồng tiếng',
...
CREATE TABLE auditoriums (
    ...
    cleaning_buffer_minutes INT NOT NULL DEFAULT 15 COMMENT 'Buffer time after movie ends before next showtime can start',
...
CREATE TABLE seats (
    ...
    pair_group VARCHAR(30) NULL COMMENT 'Used for couple seats if needed',
    status VARCHAR(30) NOT NULL DEFAULT 'ACTIVE' COMMENT 'ACTIVE, MAINTENANCE, INACTIVE',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    created_by BIGINT NULL,
    updated_by BIGINT NULL,
...
CREATE TABLE showtime_prices (
    ...
    CONSTRAINT uk_showtime_prices_type UNIQUE (showtime_id, seat_type_id),
