...
CREATE TABLE `promotion_campaigns` (
  ...
  `scope_type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'GLOBAL',
  `cinema_scope_json` json DEFAULT NULL,
  ...
  `approval_threshold_applied` decimal(18,2) DEFAULT NULL,
  `approval_policy_version` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `required_approval_capability` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `legal_notification_required` tinyint(1) NOT NULL DEFAULT '1',
  `compliance_status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'REVIEW_REQUIRED',
  `compliance_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `compliance_policy_version` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `promotions` (
  ...
  `distribution_mode` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ASSIGNED_WALLET',
  `priority` int NOT NULL DEFAULT '100',
  `stackable` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `user_promotions` (
  ...
  `automation_run_public_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `audience_member_public_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `issuance_key` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  UNIQUE KEY `uk_user_promotion_issuance` (`issuance_key`),
...
CREATE TABLE `promotion_playbooks` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `campaign_public_id` varchar(36) DEFAULT NULL,
  `promotion_public_id` varchar(36) DEFAULT NULL,
  `config_json` json NOT NULL,
  `scope_json` json NOT NULL,
  `budget_limit` decimal(18,2) DEFAULT NULL,
  `quota_limit` int DEFAULT NULL,
  `config_hash` varchar(64) DEFAULT NULL,
  `submitted_playbook_version` int DEFAULT NULL,
  `submitted_config_hash` varchar(64) DEFAULT NULL,
  `approved_playbook_version` int DEFAULT NULL,
  `approved_config_hash` varchar(64) DEFAULT NULL,
  `budget_period_key` varchar(7) DEFAULT NULL,
  `budget_committed` decimal(18,2) NOT NULL DEFAULT '0.00',
  `quota_committed` int NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`), UNIQUE KEY `uk_playbook_public` (`public_id`),
  UNIQUE KEY `uk_playbook_code` (`code`), KEY `idx_playbook_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `promotion_automation_runs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `public_id` varchar(36) NOT NULL,
  `playbook_public_id` varchar(36) NOT NULL,
  ...
  `approved_config_hash` varchar(64) NOT NULL,
  `config_snapshot_json` json NOT NULL,
  `scope_snapshot_json` json NOT NULL,
  `budget_snapshot` decimal(18,2) DEFAULT NULL,
  `quota_snapshot` int DEFAULT NULL,
  `estimated_unit_cost` decimal(18,2) NOT NULL DEFAULT '0.00',
  `trigger_type` varchar(60) NOT NULL,
  `trigger_reference` varchar(180) DEFAULT NULL,
  `trigger_source` varchar(30) NOT NULL DEFAULT 'SCHEDULE',
  `run_actor` varchar(36) NOT NULL DEFAULT 'SYSTEM',
  ...
  `deleted_at` datetime(6) DEFAULT NULL,
  `deleted_by` varchar(36) DEFAULT NULL,
  PRIMARY KEY (`id`), UNIQUE KEY `uk_automation_run_public` (`public_id`),
  UNIQUE KEY `uk_automation_run_idempotency` (`idempotency_key`),
  KEY `idx_automation_run_playbook` (`playbook_public_id`,`created_at`),
  KEY `idx_automation_run_status` (`status`,`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `promotion_audience_snapshots` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `public_id` varchar(36) NOT NULL,
  `run_public_id` varchar(36) NOT NULL,
  `audience_rule_snapshot_json` json NOT NULL,
...
CREATE TABLE `promotion_audience_members` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `public_id` varchar(36) NOT NULL,
  `snapshot_public_id` varchar(36) NOT NULL,
  `run_public_id` varchar(36) NOT NULL,
  `customer_public_id` varchar(36) NOT NULL,
  `issuance_key` varchar(180) NOT NULL,
  `status` varchar(40) NOT NULL DEFAULT 'PENDING',
  `reason_code` varchar(80) DEFAULT NULL,
  `attempt_count` int NOT NULL DEFAULT '0',
  `wallet_public_id` varchar(36) DEFAULT NULL,
  ...
  `deleted_at` datetime(6) DEFAULT NULL,
  `deleted_by` varchar(36) DEFAULT NULL,
  PRIMARY KEY (`id`), UNIQUE KEY `uk_audience_member_public` (`public_id`),
  ...
  KEY `idx_audience_member_work` (`run_public_id`,`status`,`id`),
  KEY `idx_audience_member_issuance` (`issuance_key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
CREATE TABLE `promotion_issue_jobs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `public_id` varchar(36) NOT NULL,
  `run_public_id` varchar(36) NOT NULL,
  `snapshot_public_id` varchar(36) NOT NULL,
  ...
  `deleted_at` datetime(6) DEFAULT NULL,
  `deleted_by` varchar(36) DEFAULT NULL,
  PRIMARY KEY (`id`), UNIQUE KEY `uk_issue_job_public` (`public_id`),
  KEY `idx_issue_job_run` (`run_public_id`,`created_at`),
