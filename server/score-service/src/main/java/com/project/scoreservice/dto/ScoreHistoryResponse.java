...
public class ScoreHistoryResponse {
    ...
    public ScoreHistoryResponse(Long historyId, String eventId, Long bookingId, Integer pointChange, ScoreTransactionType transactionType, Integer balanceBefore, Integer balanceAfter, Integer accumulatedBefore, Integer accumulatedAfter, Long referenceHistoryId, String description, LocalDateTime createdAt, LocalDateTime occurredAt) {
    ...
    public void setActualPointChange(Integer actualPointChange) {
        this.pointChange = actualPointChange;
    }
