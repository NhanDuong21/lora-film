...
public class OtpVerificationServiceImpl implements VerificationService {
    ...
    private RedisOtpData getRedisOtpData(String key) {
        ...
        try {
            ...
            throw new IllegalStateException("Stored OTP state is invalid", e);
        }
    }
    ...
    private void saveRedisOtpData(String key, RedisOtpData data) {
        try {
            ...
            throw new IllegalStateException("Unable to persist OTP state", e);
        }
    }
    ...
    public com.project.authservice.dto.response.SendOtpResponse sendOtp(SendOtpRequest request) {
        ...
        if (account.getAccountStatus() == com.project.authservice.enums.AccountStatus.PENDING) {
            ...
            try {
                ...
                throw new com.project.authservice.exception.common.ExternalServiceUnavailableException(
                        "Notification service", e);
            }
        }
