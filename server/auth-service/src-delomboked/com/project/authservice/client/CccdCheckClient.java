...
public class CccdCheckClient {
    ...
    public static class CccdInfo {
        ...
        public CccdInfo(
                @com.fasterxml.jackson.annotation.JsonProperty("cccdMasked") String cccdMasked,
                @com.fasterxml.jackson.annotation.JsonProperty("provinceCode") String provinceCode,
                @com.fasterxml.jackson.annotation.JsonProperty("provinceName") String provinceName,
                @com.fasterxml.jackson.annotation.JsonProperty("gender") String gender,
                @com.fasterxml.jackson.annotation.JsonProperty("birthYear") int birthYear,
