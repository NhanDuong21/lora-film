...
public class SessionDto {
    ...
    public SessionDto(String id, String ipAddress, String userAgent, String deviceName, LocalDateTime lastActiveAt, LocalDateTime createdAt, LocalDateTime expiresAt, Boolean isActive) {
        this.id = id;
        this.ipAddress = ipAddress;
        this.userAgent = userAgent;
        this.deviceName = deviceName;
    ...
    public static class SessionDtoBuilder {
        ...
        public SessionDto build() {
            return new SessionDto(this.id, this.ipAddress, this.userAgent, this.deviceName, this.lastActiveAt, this.createdAt, this.expiresAt, this.isActive);
        }
    }
}
