...
public class DepartmentController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('ADMIN','MANAGER') or hasAnyAuthority('DEPARTMENT_VIEW', 'EMPLOYEE_VIEW')")
    ...
    @PostMapping
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('DEPARTMENT_CREATE')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('DEPARTMENT_DELETE')")
