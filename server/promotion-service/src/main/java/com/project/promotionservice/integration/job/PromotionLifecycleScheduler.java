...
public class PromotionLifecycleScheduler {
    ...
    public void progressCampaignLifecycle() {
        ...
        safeRun("promotions-activate");
        safeRun("campaigns-expire");
    }

    @Scheduled(fixedDelayString = "${promotion.scheduler.promotion-expiration-delay-ms:3600000}")
    public void expirePromotionsAndWallets() {
        safeRun("promotions-expire");
        safeRun("wallet-expire");
    }
