...
@Component
public class BenefitConditionEvaluator {
    ...
    public void evaluate(JsonNode conditions, BenefitValidationRequest request) {
        ...
        if (isConfiguredArray(allowedUsers)
                && !arrayContains(allowedUsers, request.getUserPublicId())) {
