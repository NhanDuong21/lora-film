...
@Service
public class PromotionCatalogEventService {

    public static final String PROMOTION_LIFECYCLE_TOPIC = "promotion.lifecycle";
    ...
    public PromotionCatalogEventService(
    ...
    public void record(String aggregateType, String aggregatePublicId,
        ...
        event.setTopicName(PROMOTION_LIFECYCLE_TOPIC);
        ...
        try {
            ...
            throw new BusinessException(
                    ...
                    "Unable to serialize promotion event",
