...
public interface AutoScheduleGenerationContextLoader {
    default AutoScheduleGenerationContext load(NormalizedGeneratePreviewRequest request,
                                               Cinema cinema,
                                               List<Auditorium> auditoriums,
                                               List<MovieVersion> movieVersions) {
        return load(request, cinema, auditoriums, movieVersions, AutoScheduleStrategyVersions.CURRENT);
    }
