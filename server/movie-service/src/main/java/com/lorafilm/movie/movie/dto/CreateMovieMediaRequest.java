...
public class CreateMovieMediaRequest {
    ...
    public CreateMovieMediaRequest() {}

    public CreateMovieMediaRequest(MovieMediaType mediaType, String url, String title, Integer displayOrder, Boolean isPrimary, ActiveStatus status) {
