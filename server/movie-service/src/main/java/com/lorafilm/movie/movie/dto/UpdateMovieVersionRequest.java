...
public class UpdateMovieVersionRequest {
    ...
    public UpdateMovieVersionRequest() {}

    public UpdateMovieVersionRequest(String versionName, MovieFormat format, String audioLanguage, String subtitleLanguage, String dubLanguage, ActiveStatus status) {
