...
public class FoodOrderConfirmedEvent {
    private String bookingPublicId;
    private String foodOrderPublicId;
    private BigDecimal finalAmount;

    public FoodOrderConfirmedEvent() {
    }

    public FoodOrderConfirmedEvent(String bookingPublicId, String foodOrderPublicId, BigDecimal finalAmount) {
