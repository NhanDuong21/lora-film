...
class BookingServiceTest {
        ...
        void shouldCreateBookingFromValidReservations() {
                ...
                ArgumentCaptor<ConvertReservationRequest> captor = ArgumentCaptor
                                .forClass(ConvertReservationRequest.class);
        ...
        private ShowtimeBookingContext showtimeContext(Instant now) {
                return new ShowtimeBookingContext(
                                ...
                                "Room 1",
                                List.of(
                                                new ShowtimeBookingContext.SeatContext(101L, "A01", "STANDARD",
                                                                new BigDecimal("120000")),
                                                new ShowtimeBookingContext.SeatContext(102L, "A02", "STANDARD",
                                                                new BigDecimal("120000"))));
        }
