...
public interface PaymentIdempotencyRecordRepository extends JpaRepository<PaymentIdempotencyRecord, Long> {
    ...
    Optional<PaymentIdempotencyRecord> findByAccountIdAndOperationAndIdempotencyKey(Long accountId, String operation, String idempotencyKey);
    ...
    Page<PaymentIdempotencyRecord> findByProcessingStatusAndLockedAtBefore(IdempotencyProcessingStatus status, LocalDateTime lockedAt, Pageable pageable);
