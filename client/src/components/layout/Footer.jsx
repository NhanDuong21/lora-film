  ...
  return (
    <footer className="bg-zinc-950">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12 border-t border-zinc-900 text-zinc-400 text-sm">
        ...
        <div className="space-y-4">
          <h3 className="text-zinc-100 font-bold uppercase tracking-wider text-xs">ĐIỀU KHOẢN SỬ DỤNG</h3>
          <ul className="space-y-2 text-xs">
            <li><Link to="/" className="hover:text-zinc-100 transition-colors duration-200">Điều Khoản Chung</Link></li>
            <li><Link to="/" className="hover:text-zinc-100 transition-colors duration-200">Chính Sách Thanh Toán</Link></li>
            <li><Link to="/" className="hover:text-zinc-100 transition-colors duration-200">Chính Sách Bảo Mật</Link></li>
            <li><Link to="/" className="hover:text-zinc-100 transition-colors duration-200">Quy Chế Hoạt Động</Link></li>
          </ul>
        </div>

        {/* Column 3: Site Links */}
        <div className="space-y-4">
          <h3 className="text-zinc-100 font-bold uppercase tracking-wider text-xs">DANH MỤC LORAFILM</h3>
          <ul className="space-y-2 text-xs">
            <li><Link to="/movies" className="hover:text-zinc-100 transition-colors duration-200">Phim Đang Chiếu</Link></li>
            <li><Link to="/movies" className="hover:text-zinc-100 transition-colors duration-200">Hệ Thống Rạp</Link></li>
            <li><Link to="/" className="hover:text-zinc-100 transition-colors duration-200">Sự Kiện & Ưu Đãi</Link></li>
            <li><Link to="/movies" className="hover:text-zinc-100 transition-colors duration-200">Góc Điện Ảnh</Link></li>
          </ul>
        </div>

        {/* Column 4: Customer Support & Verification */}
        <div className="space-y-4">
          <h3 className="text-zinc-100 font-bold uppercase tracking-wider text-xs">CHĂM SÓC KHÁCH HÀNG</h3>
          <ul className="space-y-2 text-xs text-zinc-500">
            <li className="text-zinc-400">Hotline: <span className="text-zinc-300 font-medium">1900 LORA (10:00 - 22:00)</span></li>
            <li className="text-zinc-400">Email: <span className="text-zinc-300 font-medium">support@lorafilm.vn</span></li>
          </ul>
          <div className="pt-2">
      ...
      <div className="bg-zinc-950 border-t border-zinc-900/60">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-zinc-500 text-center md:text-left">
          <span>© 2026 LoraFilm. Movie Tickets, Your Way. All rights reserved.</span>
          <span className="text-[10px] text-zinc-600 font-medium">Cơ sở hoạt động: FPT University.</span>
        </div>
      </div>
    </footer>
  );
