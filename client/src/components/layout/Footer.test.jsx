...
describe('Footer', () => {
  it('exposes the customer policies, company introduction and supported payment methods', () => {
    render(
      <MemoryRouter>
        <Footer />
      </MemoryRouter>,
    ...
    expect(screen.getByRole('link', { name: 'Về LoraFilm' })).toHaveAttribute('href', '/#gioi-thieu');
