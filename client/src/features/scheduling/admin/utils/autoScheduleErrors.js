...
const ERROR_MESSAGES = Object.freeze({
  ...
  AUTO_SCHEDULE_DATE_IN_PAST: 'Ngày bắt đầu đã qua theo giờ địa phương của rạp.',
  ...
  AUTO_SCHEDULE_CANDIDATE_LIMIT_EXCEEDED: 'Phạm vi đã chọn tạo quá nhiều suất đề xuất. Hãy giảm số ngày, phòng hoặc định dạng phim.',
  AUTO_SCHEDULE_TOO_MANY_CANDIDATES: 'Phạm vi đã chọn tạo quá nhiều suất đề xuất. Hãy giảm số ngày, phòng hoặc định dạng phim.',
...
export const getAutoScheduleError = (error, fallback = 'Không thể tạo lịch để kiểm tra.') => {
